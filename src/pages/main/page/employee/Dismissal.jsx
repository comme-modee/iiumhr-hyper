                    ...
                    >
                        ...
                        <div>
                            ...
                            <ul>
                                <li>
                                    <div>①</div>
                                    <div>해고가 정당한 사유 없이 이루어진 경우</div>
                                </li>
                                <li>
                                    <div>②</div>
                                    <div>경영상 이유에 의한 해고 제한 요건을 갖추지 않은 경우</div>
                                </li>
                                <li>
                                    <div>③</div>
                                    <div>노동 관계 법령에서 정하고 있는 특정한 해고 금지 사유를 위반하여 해고한 경우</div>
                                </li>
                                <li>
                                    <div>④</div>
                                    <div>해고할 만한 사유가 아님에도 징계 양정을 과도하게 하여 해고한 경우</div>
                                </li>
                                <li>
                                    <div>⑤</div>
                                    <div>법령 또는 단체 협약, 취업 규칙에서 정한 해고 절차를 위반하여 해고한 경우</div>
                                </li>
                                <li>
                                    <div>⑥</div>
                                    <div>해고할 수 없는 시기에 해고를 한 경우</div>
                                </li>
                            </ul>
                        </div>
                    </motion.div>
