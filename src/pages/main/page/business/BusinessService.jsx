...
const BusinessService = () => {
    ...
    const handleBeforeChange = (beforeIndex, afterIndex) => {
        //마지막 섹션에서 넘어가지 못하게 제어
        if(afterIndex > 5) {
            setActiveIndex(5)
        } 
    };
            ...
            >
                <FullpageSection>
                    <div className={classNames(styles.sec1, commonStyles.flexCenter)}>
                        <div className={styles.title}>
                            ...
                            >
                                <span className={styles.bigSizeText}>‘최고의 파트너’</span> 입니다.
                            </motion.p>
                        </div>
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                        ...
                        >
                            ...
                            노동부 신고 대응 및 산재 처리등의 노동 사건을 함께 해결해<span className={styles.lineBreak}> </span>
                            나아가는 파트너로서 최선을 다합니다.
                        </motion.div>
                    </div>
                </FullpageSection>
                ...
                <FullpageSection>
                    <div className={classNames(styles.sec3top, commonStyles.flexCenter)}>
                        ...
                        <p className={styles.description}>
                            전문적인 지식과 다양한 실무경험을 보유하고 있는<span className={styles.lineBreak}> </span>노무법인 이음의 강력한 맨파워
                        </p>
